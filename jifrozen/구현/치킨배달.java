...
class Combination {
    ...
    public void combination(ArrayList<Position> arr, int depth, int index, int target) {// arr 은 치킨 좌표값, depth는 조합 몇개인지
                                                                                        // index 는 현재 조합의 index를 유지하기 위해
                                                                                        // target은 조합에서 차례로 넘어가는
                                                                                        // 확인
        if (depth == r) {
